...
(defconst org-texmacs--capability-alist
  '((org-element-cache-store-key . function)
    ...
    (org-link-abbrev-alist . variable)
    (org-link-abbrev-alist-local . variable)
    (org-link-types-re . variable)
    (org-link-angle-re . variable)
    (org-link-plain-re . variable)
    (org-link-bracket-re . variable)
    (org-link-any-re . variable)
    (org-element--object-regexp . variable)
    (org-element-paragraph-separate . variable)
    (org-link-make-regexps . function)
    (org-element--set-regexps . function)
    (downcase . function)
